        ...
        {transportRoutes.map(route => (
          <div key={route.hotel} style={{ backgroundColor: "var(--champagne)", borderRadius: "4px", border: "0.5px solid rgba(45,45,45,0.08)", overflow: "hidden" }}>
            ...
            <div className="flex items-center justify-between px-4 py-4" style={{ borderBottom: "0.5px solid rgba(45,45,45,0.07)" }}>
              <div>
                <p style={{ fontFamily: "var(--font-serif)", fontSize: "18px", fontWeight: 500, color: "var(--charcoal)" }}>{route.hotel}</p>
                <p style={{ fontFamily: "var(--font-sans)", fontSize: "10.5px", color: "var(--muted-foreground)", marginTop: "2px" }}>
              ...
              <div style={{ textAlign: "right" }}>
                {route.shuttles[0].status !== "private" ? (
                  <>
                    <p style={{ fontFamily: "var(--font-sans)", fontSize: "9px", letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--muted-foreground)" }}>Next shuttle</p>
                    <p style={{ fontFamily: "var(--font-serif)", fontSize: "22px", fontWeight: 400, color: "var(--charcoal)", lineHeight: 1.1 }}>
                      {route.shuttles[0].time}
                    </p>
                  </>
                ) : (
                  <span style={{ fontFamily: "var(--font-sans)", fontSize: "9px", letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--gold)" }}>Private</span>
                )}
              </div>
            </div>
            ...
            {route.shuttles.map((shuttle, idx) => (
              ...
              >
                <div>
                  <p style={{ fontFamily: "var(--font-sans)", fontSize: "8px", letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--muted-foreground)" }}>Departs</p>
                  <p style={{ fontFamily: "var(--font-sans)", fontSize: "14px", color: "var(--charcoal)", marginTop: "1px" }}>{shuttle.time}</p>
                </div>
                <div>
                  <p style={{ fontFamily: "var(--font-sans)", fontSize: "8px", letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--muted-foreground)" }}>Arrives</p>
                  <p style={{ fontFamily: "var(--font-sans)", fontSize: "14px", color: "var(--charcoal)", marginTop: "1px" }}>{shuttle.arrival}</p>
                </div>
                {shuttle.status !== "private" && shuttle.capacity > 0 ? (
                  <div>
                    <p style={{ fontFamily: "var(--font-sans)", fontSize: "8px", letterSpacing: "0.15em", textTransform: "uppercase", color: "var(--muted-foreground)" }}>Boarded</p>
                    {/* Mini capacity bar */}
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <p style={{ fontFamily: "var(--font-sans)", fontSize: "10px", color: "var(--muted-foreground)" }}>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <p style={{ fontFamily: "var(--font-sans)", fontSize: "9.5px", color: statusColor[shuttle.status], letterSpacing: "0.06em", whiteSpace: "nowrap" }}>
            ...
            {enRouteGuests.map(g => (
              <div key={g.id} className="flex items-center justify-between px-4 py-3" style={{ backgroundColor: "rgba(198,168,107,0.08)", border: "0.5px solid rgba(198,168,107,0.25)", borderRadius: "3px" }}>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <p style={{ fontFamily: "var(--font-sans)", fontSize: "10px", color: "var(--gold)" }}>En Route</p>
                </div>
              </div>
            ))}
          </div>
